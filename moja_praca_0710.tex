...
\begin{table}[!htbp]
	\begin{center}
		\begin{tabular}{l c}
			...
			AIC                         & $430650.60$     \\
			BIC                         & $430682.57$     \\
			Log Likelihood              & $-215321.30$    \\
			Num. obs.                   & $21907$         \\
			Num. groups: location       & $97$            \\
			Var: location (Intercept)   & $20700205.44$   \\
			Var: Residual               & $19715429.56$   \\
			\hline
			\multicolumn{2}{l}{\scriptsize{$^{***}p<0.001$; $^{**}p<0.01$; $^{*}p<0.05$}}
		\end{tabular}
...
$$y_{total\_cases}=\beta_0+X_{age}\beta_{age}+Z_{location}u_{location}+\varepsilon$$
...
$$y_{total\_cases}=\beta_0+X_{population\_density}\beta_{population\_density}+Z_{location}u_{location}+\varepsilon$$
...
$$y_{total\_cases}=\beta_0+X_{HDI}\beta_{HDI}+Z_{location}u_{location}+\varepsilon$$
...
\end{table}
 ...
 Efekt stały jest istotny i ma wpływ stymulujacy. W krajach z wyższym wskaźnikiem rozwoju społecznego, zachorowań jest znacząco więcej.
...
$$y_{total\_cases}=\beta_0+X_{cardiovasc\_death\_rate}\beta_{cardiovasc\_death\_rate}+$$$$+Z_{location}u_{location}+\varepsilon$$
...
$$y_{total\_cases}=\beta_0+X_{diabetes\_prevalence}\beta_{diabetes\_prevalence}+Z_{location}u_{location}+\varepsilon$$
...
$$y_{total\_cases}=\beta_0+X_{extreme\_poverty}\beta_{extreme\_poverty}+Z_{location}u_{location}+\varepsilon$$
...
$$y_{total\_cases}=\beta_0+X_{GDP}\beta_{GDP}+Z_{location}u_{location}+\varepsilon$$
