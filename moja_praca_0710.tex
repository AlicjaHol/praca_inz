...
\begin{table}[!h]
	\begin{center}
		...
		\end{tabular}
		\caption{Wyniki dla modelu mieszanego z uwzględnieniem wpływu kraju \\na wyraz wolny}
		\label{table:model1}
		\zrodlo{Opracowanie własne}
	\end{center}
\end{table}
...
\begin{table}[!htbp]
	\begin{center}
		\begin{tabular}{l c}
			...
			\multicolumn{2}{l}{\scriptsize{$^{***}p<0.001$; $^{**}p<0.01$; $^{*}p<0.05$}}
		\end{tabular}
		\caption{Wyniki dla modelu mieszanego uwzględniającego wpływ \\kraju na wyraz wolny}
		\label{table:model2}
		\zrodlo{Opracowanie własne}
	\end{center}
\end{table}
...
\bibitem{wykres} Pogotowie Statystyczne, \emph{Analizy statystyczne bez tajemnic, czyli dziwne wyniki analizy korelacji w podziale na podzbiory - cz.1} (dostęp: 21.01.2021)
