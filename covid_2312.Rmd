...
mod_lm_potega <- lm(total_cases_per_million~I(life_expectancy^4), covid)
summary(mod_lm_potega)
covid_miesiace %>% 
  ggplot(aes(life_expectancy, total_cases_per_million^4))+
  geom_point()+
  geom_smooth(method=lm, formula=y~x)

covid_miesiace %>% 
  ggplot(aes(life_expectancy, log(total_cases_per_million)))+
  geom_point()+
  geom_smooth(method=lm, formula=y~x)
...
mod5_lm2 <- lm(total_cases_per_million~I(human_development_index^2), covid_hdi)
summary(mod5_lm2)
covid_hdi %>% 
  ggplot(aes(human_development_index^2,total_cases_per_million))+
  geom_point()+
  geom_smooth(method=lm,se=F)
covid_hdi %>% 
  ggplot(aes(human_development_index,log(total_cases_per_million)))+
  geom_point()+
  geom_smooth(method=lm,se=F)
```
...
mod6_lm2 <- lm(total_cases_per_million~I(cardiovasc_death_rate^(1/3)), covid_miesiace)
summary(mod6_lm2)
covid_miesiace %>% 
  ggplot(aes(cardiovasc_death_rate^(1/3), total_cases_per_million))+
  geom_point()+
  geom_smooth(method=lm)
```
...
mod7_lm2 <- lm(total_cases_per_million~I(diabetes_prevalence^(1/3)), covid_miesiace)
summary(mod7_lm2)
covid_miesiace %>% 
  ggplot(aes(diabetes_prevalence^(1/3), total_cases_per_million))+
  geom_point()+
  geom_smooth(method=lm)
```
...
mod8_lm2 <- lm(I(total_cases_per_million^0.2)~extreme_poverty, covid_miesiace)
summary(mod8_lm2)
covid_miesiace %>% 
  ggplot(aes(extreme_poverty, total_cases_per_million^0.2))+
  geom_point()+
  geom_smooth(method=lm, se=F)
```
...
mod9_lm2 <- lm(I(total_cases_per_million^(1/3)) ~gdp_per_capita, covid_miesiace)
summary(mod9_lm2)
covid_miesiace %>% 
  ggplot(aes(gdp_per_capita, total_cases_per_million^(1/3)))+
  geom_point()+
  geom_smooth(method=lm, se=F)
```
